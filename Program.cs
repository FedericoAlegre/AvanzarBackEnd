...
builder.Services.AddSingleton(serviceProvider =>
{
    ...
    var clientId = "AYrY_nZtqntPIktP4uo-ixENxp50Bqz4Hxluo__xHBUMuPFpKw6w1Zt_1A9LRpspduZvMnIsNSpRYI2k";//configuration["PayPal:ClientId"];
    ...
    var environment = "sandbox";//configuration["PayPal:Environment"];
